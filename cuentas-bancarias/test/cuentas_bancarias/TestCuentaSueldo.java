...
public class TestCuentaSueldo {
	...
	public void queNoSeCobreAdicionalLuegoDeLaQuintaExtraccionEnUnaCuentaSueldo() {
		...
		final Double VE = IMPORTE_DEPOSITO - (IMPORTE_EXTRACCION_1 + IMPORTE_EXTRACCION_2 + IMPORTE_EXTRACCION_3 + IMPORTE_EXTRACCION_4 + IMPORTE_EXTRACCION_5 + IMPORTE_EXTRACCION_6);
